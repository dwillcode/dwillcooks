      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-orange-400 mb-4">dwillcooks</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/blog?category=italian" className="text-gray-300 hover:text-orange-400 transition-colors">
                  Italian Cuisine
                </Link>
              </li>
              <li>
                <Link href="/blog?category=baking" className="text-gray-300 hover:text-orange-400 transition-colors">
                  Baking
                </Link>
              </li>
              <li>
                <Link href="/blog?category=gardening" className="text-gray-300 hover:text-orange-400 transition-colors">
                  Gardening
                </Link>
              </li>
              <li>
                <Link href="/shop?category=baking-supplies" className="text-gray-300 hover:text-orange-400 transition-colors">
                  Baking Supplies
                </Link>
              </li>
            </ul>
